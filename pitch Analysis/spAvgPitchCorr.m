% NAME
%   spAvgPitchCorr: Pitch Tracking via the Auto-correlation Method 
% SYNOPSIS
%   [F0, T, R] = 
%     spAvgPitchCorr(x, fs, frame_length, frame_overlap, maxlag, show)
% DESCRIPTION
...
function F0 = spAvgPitchCorr(x, fs, frame_length, frame_overlap, maxlag, show)
 %% Initialization
 N = length(x);
